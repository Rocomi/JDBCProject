...
public class Member {
	...
	public Member(int userNo, String userId, String userPw, String userName, char gender,
			int age, String email, String address, String phone, String hobby, Date enrollDate) {
		super();
		this.userNo = userNo;
		this.userId = userId;
		this.userPw = userPw;
